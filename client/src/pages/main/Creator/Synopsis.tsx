    ...
    <>
      <DashboardLayout>
        <div>
          ...
          <div className=" grid md:grid-cols-2 grid-cols-1 rounded-t-xl overflow-hidden -translate-y-10 shadow-xl min-h-[500px]">
            <div className="col-span-1 bg-[#fae8e6] p-10 space-y-10 flex flex-col">
              ...
              <div className="space-y-10 ms-0 mt-auto">
                <div className="center">
                  <Link
                    to={`/creator/preview/${comic?.id}?ep=${episodeNumber}`}
                  >
        ...
        <div className="flex gap-4 mt-10">
            <ButtonWithLoader initialText="Edit" loadingText="Editing..." loading={false} className="h-10 px-4 bg-primary/50 rounded-md" />
            <ButtonWithLoader initialText="Delete" loadingText="Deleting..." loading={false} className="h-10 px-4 bg-red-500 text-white rounded-md" />
            <Link to={`/creator/upload?type=existing`} className="h-10 px-4 bg-secondary btn text-white rounded-md">Add Episode</Link>
        </div>
      </DashboardLayout>
    </>
  );
